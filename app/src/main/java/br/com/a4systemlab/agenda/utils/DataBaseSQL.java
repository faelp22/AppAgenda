...
public class DataBaseSQL {
    ...
    public static String getAtividade() {
        ...
        atividade.append("    user_id INTEGER NOT NULL, ");
    ...
    public static String getContato() {
        ...
        contato.append("    user_id INTEGER NOT NULL, ");
    ...
    public static String getCompromisso() {
        ...
        compromisso.append("    user_id INTEGER NOT NULL, created_at datetime NOT NULL, ");
        compromisso.append("    updated_at datetime NOT NULL, status INTEGER NOT NULL, ");
